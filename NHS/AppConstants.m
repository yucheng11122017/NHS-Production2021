...
NSString *const kFitLast2Mths= @"fit_last_2_mths";
...
NSString *const kDMCurrentlPrescribed= @"dm_currently_prescribed";
...
NSString *const kHTCheckedBlood= @"ht_checked_blood";
